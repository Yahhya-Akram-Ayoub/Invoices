				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_partially_paid') }}">الفواتير المدفوعة جزئيا</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='archived_invoiced') }}">الفواتير المؤرشفة</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='custmers_report') }}">تقارير العملاء</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='section') }}"> ادارة الاقسام </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product') }}">ادارة المنتجات </a></li>
