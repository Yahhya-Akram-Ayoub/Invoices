<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							...
							<span class="mb-0 text-muted">{{Auth::user()->email}}r</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
                    ...
                    @can('Invoices')	<li class="side-item side-item-category">الفواتير</li>@endcan
					<li class="slide">
					...
					@can('Report')<li class="side-item side-item-category">التقارير</li>@endcan
					<li class="slide">
					...
					@can('Users')<li class="side-item side-item-category">المستخدمين</li>@endcan
					<li class="slide">
				...
				@can('Sittings')	<li class="side-item side-item-category">الاعدادات</li>@endcan
					<li class="slide">
